...
import { ILoginDriverReq } from '@/models/ILoginDriverReq'
import { ILoginDriverResOk } from './ILoginDriverResOk'
...
export default function LoginDriverPage() {
    ...
    async function handleLogin(event: React.FormEvent<HTMLFormElement>) {
        ...
        const loginData: ILoginDriverReq = {
            password: password,
        }
        ...
        try {
            const response = await axiosInstance.post<ILoginDriverResOk>('/auth/driver/login', loginData)
